...
Virtual Machine - A software-based computer that runs within a physical computer. (i.e. Running Windows 11 on a Linux Machine)

The Hypervisor I will be using is Kernel-based Virtual Machine (KVM) with QEMU Virtual Machine emulator.
